        ...
        if "ESX" == L1_3 then
          ...
          if "QBCore" == L1_3 then
            ...
            for L6_3, L7_3 in L2_3, L3_3, L4_3, L5_3 do
              ...
              L10_3.header = L11_3
              L11_3 = {}
              L11_3.event = "qb-menu:client:changeNumber"
              L12_3 = {}
              L12_3.number = L7_3
              L11_3.args = L12_3
              L10_3.params = L11_3
...
openMenu = L0_1
L0_1 = AddEventHandler
L1_1 = "qb-menu:client:changeNumber"
function L2_1(A0_2)
  local L1_2, L2_2
  L1_2 = openActionMenu
  L2_2 = A0_2.number
...
function L0_1(A0_2)
  ...
  if "ESX" == L1_2 then
    ...
    if "QBCore" == L1_2 then
      ...
      L4_2.header = L5_2
      L5_2 = {}
      L5_2.event = "qb-menu:client:changeNumber:confirm"
      L6_2 = {}
      L6_2.number = A0_2
      L5_2.args = L6_2
      L4_2.params = L5_2
      ...
      L4_2.header = L5_2
      L5_2 = {}
      L5_2.event = "qb-menu:client:close"
      L4_2.params = L5_2
      L2_2(L3_2, L4_2)
      L2_2 = TriggerEvent
      L3_2 = "qb-menu:client:openMenu"
      L4_2 = L1_2
      L2_2(L3_2, L4_2)
    end
  end
...
openActionMenu = L0_1
L0_1 = AddEventHandler
L1_1 = "qb-menu:client:changeNumber:confirm"
function L2_1(A0_2)
